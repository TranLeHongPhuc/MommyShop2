...
public class MailerService {
    ...
    public void send(MailInfo mail) throws MessagingException {
        ...
        String htmlContent = templateEngine.process("new-email.html", context);
        ...
        helper.addInline("5_facebook2x.png", new ClassPathResource("static/assets/images/facebook2x.png"));
        helper.addInline("6_twitter2x.png", new ClassPathResource("static/assets/images/twitter2x.png"));
        helper.addInline("7_instagram2x.png", new ClassPathResource("static/assets/images/instagram2x.png"));
        helper.addInline("8_linkedin2x.png", new ClassPathResource("static/assets/images/linkedin2x.png"));
        helper.addInline("9_logoSaleNoti.png", new ClassPathResource("static/assets/images/logoSaleNoti.png"));
        helper.addInline("10_favicon.ico", new ClassPathResource("static/assets/images/favicon.ico"));
